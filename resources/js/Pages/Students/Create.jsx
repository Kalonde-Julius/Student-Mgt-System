...
export default function Create() {
  ...
  const handleSubmit = (e) => {
    ...
    // Use the correct route and pass `data`
    post('/students', {
      data,
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="bg-white shadow-lg rounded-lg w-full max-w-2xl p-5">
        ...
        <h1 className="text-2xl font-bold mb-6 text-center"> Create Student </h1>
        ...
        <section className="mt-6 text-center">
            <article className="mt-6 text-center text-gray-600 flex flex-col-2 justify-between gap-4">
                <Link href="/students" className="text-white font-medium rounded bg-gray-600 px-4 py-2 hover:bg-gray-700 transition">
                    Students List
                </Link>

                <Link href="/dashboard" className="text-white font-medium rounded bg-gray-600 px-4 py-2 hover:bg-gray-700 transition">
                    Dashboard
                </Link>
            </article>
        </section>
